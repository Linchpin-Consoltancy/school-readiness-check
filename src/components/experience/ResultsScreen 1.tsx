...
function ContactBlock({
  ...
  const lowestName = lowest
    ? (DOMAIN_BY_ID.get(lowest.domainId)?.name ?? "One of the seven areas")
    ...
    return (
      <section className="mt-10 rounded-[4px] border border-onyx/10 bg-ivory p-7 sm:p-9">
        ...
        <p className="mt-4 max-w-[50ch] text-[0.94rem] leading-[1.7] text-charcoal/85">
          We will be in touch shortly about what your results show for{" "}
          {schoolName}. If you would rather we did not, say so when we write and
          we will remove your details.
        </p>
        <p className="mt-4 max-w-[50ch] text-[0.94rem] leading-[1.7] text-charcoal/85">
          If it is easier, start the conversation yourself. Your report is
          already on your device, so bring it with you.
        </p>
        <a
          href={whatsappLink(
            `Hello Linchpin, I have just completed the School Readiness Check for ${schoolName}. ${lowestName} came out as the area needing attention first, and I would like to talk about it.`,
          )}
          target="_blank"
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-5 py-12 sm:px-6 sm:py-16">
      ...
      <section className="mt-10 rounded-[4px] border border-amber/30 bg-amber/[0.05] p-7 sm:p-9">
        <p className={eyebrowText}>Entry point</p>
        <h2 className="mt-4 font-display text-[1.7rem] leading-tight text-onyx">
          The Linchpin School Diagnostic
        </h2>

        <p className="mt-5 max-w-[52ch] text-[0.96rem] leading-[1.75] text-charcoal/85">
          You have just told us how {schoolName} looks from where you sit. That
        ...
        <p className="mt-4 max-w-[52ch] text-[0.96rem] leading-[1.75] text-charcoal/85">
          The Diagnostic brings all of that together. It is a structured, two
          day process that sets your leadership perspective beside three other
          sources of evidence, so that what you end up acting on is validated
          rather than assumed.
        </p>

        <ol className="mt-7 space-y-4 border-t border-onyx/10 pt-6">
          <li className="flex gap-4">
            <span className="font-display text-[1.1rem] leading-none text-amber">
              1
            </span>
            <span className="text-[0.92rem] leading-[1.65] text-charcoal/85">
              <span className="font-medium text-onyx">Staff and student voice.</span>{" "}
              The people who live in your systems every day, asked directly, so
              you can see where their picture and yours part company.
            </span>
          </li>
          <li className="flex gap-4">
            <span className="font-display text-[1.1rem] leading-none text-amber">
            ...
            <span className="text-[0.92rem] leading-[1.65] text-charcoal/85">
              <span className="font-medium text-onyx">Classroom observation.</span>{" "}
              Direct time in lessons, watching what happens rather than what is
              reported.
            </span>
          </li>
          <li className="flex gap-4">
            ...
            <span className="text-[0.92rem] leading-[1.65] text-charcoal/85">
              <span className="font-medium text-onyx">Document review.</span>{" "}
              The schemes, records and routines your school already runs on,
              read against what they are meant to be doing.
            </span>
          </li>
        </ol>

        <div className="mt-7 rounded-[3px] border border-onyx/10 bg-white p-5">
          <p className="text-[0.66rem] uppercase tracking-[0.18em] text-dusk">
            What your school gets
          </p>
          <p className="mt-3 text-[0.92rem] leading-[1.7] text-charcoal/85">
            A validated picture of your systems, a written report with
            prioritised findings, and a clear roadmap for improvement, together
            with a shared language that carries into every conversation your
            leadership team has afterwards.
          </p>
        </div>

        <p className="mt-7 max-w-[52ch] text-[0.94rem] leading-[1.7] text-charcoal/85">
          Every school is a different size and a different problem, so tell us
          about yours and we will come back with what it would involve and what
          it would cost. Asking costs nothing, and you will know inside twenty
          minutes whether we are the right people for {schoolName}.
        </p>

        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <a
            href={whatsappLink(
              `Hello Linchpin, I have just completed the School Readiness Check for ${schoolName}. ${lowestName} came out as the area needing attention first. I would like to hear what the Linchpin School Diagnostic would involve for us.`,
            )}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href={`mailto:${CONTACT.email}?subject=${encodeURIComponent(
              `School Diagnostic enquiry, ${schoolName}`,
            )}&body=${encodeURIComponent(
              `Hello Linchpin,\n\nI have just completed the School Readiness Check for ${schoolName}. ${lowestName} came out as the area needing attention first.\n\nI would like to hear what the Linchpin School Diagnostic would involve for us.\n\n`,
            )}`}
        ...
        <p className="mt-6 text-[0.84rem] leading-relaxed text-dusk">
          Or call or message {CONTACT.whatsappDisplay}. You will reach{" "}
          {CONTACT.personName}.
        </p>
      </section>
